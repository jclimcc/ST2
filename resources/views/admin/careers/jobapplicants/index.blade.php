            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        ...
                        {{ Breadcrumbs::render('admins.careers.jobapplicant') }}
                    </div>                    
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive pt-3">
                            <table class="table table-bordered" id="posts-page">
                                ...
                                <tbody>
                                    @foreach ($getJobApplicants as $applicant)
                                    <tr>
                                        <td>{{ $loop->index+1 }}</td>
                                        <td>{{ date('Y-m-d H:i', strtotime( $applicant['created_at']));}}</td>
                                        <td>
                                            <a>
                                                {{ $applicant['name'] }}    
                                            </a>
                                            <br />
                                            <small>
                                                Applied Job:{{ $applicant['career']['title'] }} | H.Phone: {{  $applicant['phone'] }} | Email: {{  $applicant['email'] }}
                                            </small>
