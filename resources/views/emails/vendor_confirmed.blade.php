                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c es-p15t" align="center">
                                                                                        <p> Congraduration Become our VIPSTORE Store Vendor!</p>
                                                                                        <h1>Step1 - Fill in your Business Profile </h1>
                                                                                        <h1>Step2 - Fill in your Bank Details </h1>
                                                                                        <h1>Step3 - Upload and publish your produt to your store. </h1>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p15b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="{{url('vendor/login')}}" class="es-button" target="_blank">Login</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
