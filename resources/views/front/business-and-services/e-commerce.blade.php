...
<!-- Content
		...
		<section id="content">
			...
			<div class="content-wrap pb-0">
				...
				style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #39384D), url('{{ url('images/aboutus/parallax/demo1.jpg')}}'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 40px;" data-top-bottom="background-position:0px -40px;">
