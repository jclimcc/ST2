    ...
    <div id="rev_slider_679_1_wrapper" class="rev_slider_wrapper fullwidth-container"  style="padding:0px;">
      ...
      <div id="rev_slider_679_1" class="rev_slider fullwidthbanner" style="display:none;" data-version="5.1.4">
        <ul>    <!-- SLIDE  -->
          ...
          <!-- SLIDE  -->
          <li data-transition="slideup" data-slotamount="1" data-masterspeed="2000" data-thumb="{{ url('front/banners/'.$banner['image'])}}" data-delay="10000"  data-saveperformance="off"  data-title="{{$banner['title']}}">
            <!-- MAIN IMAGE -->
            ...
            data-endspeed="1000"
            data-endeasing="Power4.easeIn" style="z-index: 3; color: #333; white-space: nowrap;"> {{$banner['title']}}</div>
            @endif
            @if($banner['sub_title']!="")
            ...
            data-endelementdelay="0.1"
            data-endspeed="1000"
            data-endeasing="Power4.easeIn" style="z-index: 3; color: #333; white-space: nowrap;">{{$banner['sub_title']}}</div>
            @endif
            ...
            data-endspeed="1000"
            data-endeasing="Power4.easeIn" style="z-index: 3; color: #333; max-width: 650px; white-space: normal;">{{$banner['description']}}</div>
            @endif
            @if($banner['url']!="")
            ...
            data-endelementdelay="0.1"
            data-endspeed="1000"
            data-endeasing="Power4.easeIn" style="z-index: 3;"><a href="{{$banner['url']}}" class="button button-border button-large button-rounded text-end m-0"><span>{{$banner['button_label']}}</span><i class="icon-angle-right"></i></a></div>
            @endif
          </li>
