            ...
            if (pluginFnExec) {
                ...
                if (!disableAJAX) {
                    $.ajax({
                        ...
                        .done(function () {
                            SEMICOLON.initialize.execPlugin(
                                element,
                                settings,
                                false
                            );
    ...
    SEMICOLON.header = {
        ...
        menuInvert: function (subMenuEl) {
            ...
            submenus.each(function (index, element) {
                ...
                if (
                    viewportOffset.left + viewportOffset.width - windowWidth >
                    0
                ) {
                    element.classList.add("menu-pos-invert");
                }
    ...
    SEMICOLON.widget = {
        ...
        masonryThumbs: function (element) {
            let settings = {
                ...
                pluginfn: () =>
                    $().isotope &&
                    typeof scwMasonryThumbsPlugin !== "undefined",
            ...
            if ($body.hasClass("adaptive-color-scheme")) {
                ...
                let adaptClasses = function (dark) {
                    if (dark) {
                        ...
                        adaptiveEl
                            .removeClass(adaptLightClass)
                            .addClass(adaptDarkClass);
                    } else {
                        $body.toggleClass("dark", false);
                        adaptiveEl
                            .removeClass(adaptDarkClass)
